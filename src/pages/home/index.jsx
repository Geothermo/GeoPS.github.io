      ...
      <div className="home-page">
        <section className="top-section">
          ...
          <div className="vertical-middle">
            ...
            <p className="product-desc">{dataSource.brand.briefIntroduction3}</p>
          </div>
        ...
        <section className="introduction-section">
          <div className="introduction-body">
            <div className="introduction">
              ...
              <p>{dataSource.introduction.desc1}</p>
              <p>{dataSource.introduction.desc2}</p>
              <p>{dataSource.introduction.desc3}</p>
              <a href={getLink(dataSource.introduction.button.link)} target={dataSource.introduction.button.link || '_self'}>{dataSource.introduction.button.text}</a>
            </div>
        ...
        <section className="start-section">
          <div className="start-body">
            <div className="left-part">
              ...
              <p>{dataSource.start.desc1}</p>
              <p>{dataSource.start.desc2}</p>
              <p>{dataSource.start.desc3}</p>
              <p>{dataSource.start.desc4}</p>
